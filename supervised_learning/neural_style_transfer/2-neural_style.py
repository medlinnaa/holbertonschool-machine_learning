...
class NST:
    ...
    def gram_matrix(input_layer):
        ...
        # einsum performs the dot product across the spatial dimensions
        # b = batch, h = height, w = width, c = channels, d = channels
        result = tf.linalg.einsum('bhwc,bhwd->bcd', input_layer, input_layer)

        # Get spatial dimensions (height * width) to calculate the average
