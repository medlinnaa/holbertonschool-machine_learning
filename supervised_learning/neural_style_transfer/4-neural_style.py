...
class NST:
    ...
    def layer_style_cost(self, style_output, gram_target):
        ...
        Args:
            style_output (tf.Tensor): The layer style output of the
                generated image.
            gram_target (tf.Tensor): The gram matrix of the target style
        ...
        # Calculate the gram matrix of the generated image's output
