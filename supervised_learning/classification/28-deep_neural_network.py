#!/usr/bin/env python3
"""Defines a deep neural network with multiple activation options"""
import numpy as np
import os
...
class DeepNeuralNetwork:
    ...
    def __init__(self, nx, layers, activation='sig'):
        ...
        activation: type of activation used in hidden layers
        """
    ...
    def forward_prop(self, X):
        ...
        for layer in range(1, self.__L + 1):
            ...
            if layer < self.__L:
                ...
                # Last layer always uses Softmax for multiclass
                exp_z = np.exp(z)
    ...
    def gradient_descent(self, Y, cache, alpha=0.05):
        """Calculates one pass of gradient descent with dynamic derivative"""
        m = Y.shape[1]
        ...
        for layer in range(self.__L, 0, -1):
            ...
            if layer > 1:
                if self.__activation == 'sig':
                    ...
                    dz = np.matmul(w_curr.T, dz) * (1 - (a_prev ** 2))
