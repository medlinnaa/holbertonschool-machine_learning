#!/usr/bin/env python3
"""
Module to build a Decision Tree with a final prediction function
"""
import numpy as np
...
class Node:
    ...
    def pred(self, x):
        """ Prediction for a single individual by walking down """
...
class Leaf(Node):
    ...
    def update_indicator(self):
        """ Leaf version of indicator exists through inheritance """
...
class Decision_Tree():
    ...
    def update_predict(self):
        """ Builds the vectorized prediction function """
        self.update_bounds()
    ...
    def pred(self, x):
        """ 'Old school' step-by-step prediction """
