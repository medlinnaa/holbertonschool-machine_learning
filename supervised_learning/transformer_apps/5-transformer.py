#!/usr/bin/env python3
"""
Complete Transformer implementation for machine translation.
"""
...
def point_wise_feed_forward_network(d_model, dff):
    """Creates the point-wise feed-forward network."""
...
class MultiHeadAttention(tf.keras.layers.Layer):
    ...
    def call(self, v, k, q, mask):
        ...
        concat_attention = tf.reshape(
            output, (batch_size, -1, self.d_model)
        )
...
class Transformer(tf.keras.Model):
    """
    The main Transformer model that connects the Encoder and Decoder.
    """
    ...
    def __init__(self, N, dm, h, hidden, input_vocab, target_vocab,
        ...
        Args:
            ...
            hidden (int): Number of hidden units in the FC layers.
    ...
    def call(self, inputs, target, training, encoder_mask,
        ...
        Args:
            ...
            look_ahead_mask: The mask for the 1st attention block in decoder.
            decoder_mask: The padding mask for 2nd attention block in decoder.
