...
with Timestamp as the first index level and the exchange (bitstamp/coinbase)
as the second level.
"""
...
def hierarchy(df1, df2):
    ...
    - Sorts to ensure chronological order by Timestamp.
    ...
    # Current index order: (exchange, Timestamp) -> swap to (Timestamp, exchange)
